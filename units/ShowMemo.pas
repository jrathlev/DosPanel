...
begin
  if Visible then begin
    ...
    if not PosFromIni then with Position do begin
...
begin
  ...
  Execute(Title,TextDatei,PrevCap1,NextCap1,SrchText1,PrevCap2,
    NextCap2,SrchText2,Filter,Position,Line,DlgType,Buttons,CodePage);
  end;
...
begin
  ...
  ShowtextDialog.Execute(Title,TextDatei,PrevCap1,NextCap1,SrchText1,PrevCap2,
    NextCap2,SrchText2,Filter,Position,Line,DlgType,Buttons,PrtSettings,CodePage);
